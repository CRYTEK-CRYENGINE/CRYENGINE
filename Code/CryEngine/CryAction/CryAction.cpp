...
void CCryAction::PreSystemUpdate()
{
	...
	bool bGameIsPaused = !IsGameStarted() || IsGamePaused(); // slightly different from m_paused (check's GetGTimer() as well)
...
bool CCryAction::PostSystemUpdate(bool haveFocus, CEnumFlags<ESystemUpdateFlags> updateFlags)
{
	...
	bool isGamePaused = !IsGameStarted() || IsGamePaused(); // slightly different from m_paused (check's GetGTimer() as well)
...
void CCryAction::PreFinalizeCamera(CEnumFlags<ESystemUpdateFlags> updateFlags)
{
	...
	const bool bGameIsPaused = IsGamePaused(); // slightly different from m_paused (check's GetGTimer() as well)
