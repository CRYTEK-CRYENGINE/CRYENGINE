...
int main(int argc, char* argv[])
{
	...
	{
		translationFilesPath = engineRootDir.c_str() + QString("/Editor/Translations/zh_CN/");
	}
	else if(editorLang == "TChinese")
	{
		translationFilesPath = engineRootDir.c_str() + QString("/Editor/Translations/zh_TW/");
	}
	else if(editorLang =="Japanese")
	{
		translationFilesPath = engineRootDir.c_str() + QString("/Editor/Translations/ja/");
	}
	else if (editorLang == "Korean")
	{
		translationFilesPath = engineRootDir.c_str() + QString("/Editor/Translations/ko/");
	}
