...
def cmd_upgrade(args):
    ...
    try:
        with open(args.project_file, 'r') as fd_project:
    ...
    restore_version = {'5.0.0': '5.0.0',
                       '5.1.0': '5.1.0',
                       '5.1.1': '5.1.0'}.get(engine_version)
    ...
    # Solutions
    for (dirpath, _, filenames) in os.walk('Code'):
    ...
    with zipfile.ZipFile(zfilename, 'r') as z:
